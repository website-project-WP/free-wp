...
<body>
	...
	<header class="text-center">
		<a href="<?php echo $protocols.'://'.$sites['domain']; ?>"><img src="<?php echo $images['manager']['logo']['big']; ?>" alt="<?php echo $sites['name']; ?>"></a>
	</header>
	...
	<section>
		...
		<strong>'.$email['index']['content']['email'].':</strong> {email}<br /><br />
		<strong>'.$email['index']['content']['name'].':</strong> {name}<br /><br />
		<strong>'.$email['index']['content']['phone'].':</strong> {phone}<br /><br />
