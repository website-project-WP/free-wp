...
<urlset xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd http://www.google.com/schemas/sitemap-image/1.1 http://www.google.com/schemas/sitemap-image/1.1/sitemap-image.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
	...
	<? #################################	ABOUT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$about['index']['url']['default']; ?></loc>
	...
	<? #################################	POOL SERVICES		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['index']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['animal']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['immo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['sport']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['designer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['translator']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['editor']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['lawyer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['list']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['seo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['formation']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['informatique']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['webmaster']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['developper']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['hacker']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['music']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['gaming']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['entrepreneur']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['meet']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['photo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pool['crypto']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	Tarif		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pricing['index']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pricing['devis']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pricing['freelancer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$pricing['base']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	CONTACT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$email['index']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	CV		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['cv']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	SHOP		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['shop']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	SERVER		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['server']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	PROJECT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['project']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	INVEST		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['invest']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	DOWNLOAD		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['download']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	DONATION		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['donation']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	STREAM		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$general['stream']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
