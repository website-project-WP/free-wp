...
<urlset xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd http://www.google.com/schemas/sitemap-image/1.1 http://www.google.com/schemas/sitemap-image/1.1/sitemap-image.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['index']['url']['en']; ?></loc>
	...
	<? #################################	ABOUT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$about['index']['url']['fr']; ?></loc>
	...
	<? #################################	POOL SERVICES		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['index']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['animal']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['immo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['sport']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['designer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['translator']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['editor']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['lawyer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['list']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['formation']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['seo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['informatique']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['webmaster']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['developper']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['hacker']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['music']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['gaming']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['entrepreneur']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['meet']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['photo']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pool['crypto']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	Tarif		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pricing['index']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pricing['devis']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pricing['freelancer']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$pricing['base']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	CONTACT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$email['index']['url']['fr']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	CV		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['cv']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	SHOP		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['shop']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	SERVER		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['server']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	PROJECT		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['project']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	INVEST		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['invest']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	DOWNLOAD		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['download']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	DONATION		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['donation']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	STREAM		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$general['stream']['url']['default']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	PARTNER		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$partner['index']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	SPONSOR		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$sponsor['index']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	LAW		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['pages']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['cgu']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['cgv']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['dmca']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['legal']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['policy-privacy']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['english'].'/'.$law['rgpd']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
