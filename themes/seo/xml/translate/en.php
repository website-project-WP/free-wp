...
<urlset xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd http://www.google.com/schemas/sitemap-image/1.1 http://www.google.com/schemas/sitemap-image/1.1/sitemap-image.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$general['index']['url']['en']; ?></loc>
	...
	<? #################################	PARTNER		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$partner['index']['url']['en']; ?></loc>
	...
	<? #################################	SPONSOR		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$sponsor['index']['url']['en']; ?></loc>
		<changefreq>weekly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<? #################################	LAW		################################# ?>
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['pages']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['cgu']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['cgv']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['dmca']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['legal']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['policy-privacy']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
	...
	<url>
		<loc><?php echo $protocols.'://'.$sites['domain'].'/'.$translate['manual']['frontend']['french'].'/'.$law['rgpd']['url']['en']; ?></loc>
		<changefreq>monthly</changefreq>
		<priority>1</priority>
		<?php 
